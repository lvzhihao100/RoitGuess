 ...
 */
public class HeartSprite extends BasePropSprite {
    @Override
    public void init() {

        sprite = CCSprite.sprite("desk/heart.png");
    ...
    public void showPower(LuckyGuessLayer layer) {
        layer.luckyData.setBloodme((layer.luckyData.getBloodme()+3)>7?7:layer.luckyData.getBloodme()+3);
