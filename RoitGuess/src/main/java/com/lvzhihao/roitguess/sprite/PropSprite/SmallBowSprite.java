 ...
 */
public class SmallBowSprite extends BasePropSprite {
    @Override
    public void init() {

        sprite = CCSprite.sprite("desk/s_bow.png");
    ...
    public void showPower(LuckyGuessLayer layer) {
        ...
        layer.luckyData.setBloodemy((layer.luckyData.getBloodme()-1)<0?0:layer.luckyData.getBloodemy()-1);
